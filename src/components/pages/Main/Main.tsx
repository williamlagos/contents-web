...
import { Heading, Paragraph, Box, Image, Button } from 'grommet'
import { Favorite, ShareOption } from 'grommet-icons'

import labsOutline from './assets/labs_outline.svg'
import rocketImage from './assets/rocket.svg'
import hexagonLogo from './assets/hubpro.svg'
import dinamoImage from './assets/new.svg'
  ...
  <Layout>
    <Box margin="large" align="center">
      ...
      <Heading level={2} margin="small">
        The next inspiration starts here.
      </Heading>
