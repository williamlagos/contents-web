import { Anchor, Box, Grid, Heading, PageHeader, Paragraph } from 'grommet'
...
const Contents = ({ items }: ContentsProps) => (
  <>
    ...
    />
    <Blocks columns={columnsConfig}>
      <Block pad="medium" background="#00b34b">
      ...
      <Block pad="medium" background="#156aff">
      ...
      <Block pad="medium" background="#741b47">
